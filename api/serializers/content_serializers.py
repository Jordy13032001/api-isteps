...
class CursoListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Curso
        fields = ["id", "titulo", "descripcion", "imagen_url", "tipo", "codigo_externo", "destacado", "inscritos_count"]
...
class AutoridadCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        # ð¹ Si es update, usar valores existentes
        if self.instance:
...
# SERIALIZERS PARA BOTONES DE SOPORTE

class BotonSoporteSerializer(serializers.ModelSerializer):
    """
    Serializer para los botones de soporte técnico.
    """
    class Meta:
        model = BotonSoporte
        fields = [
