...
class CursoAdmin(admin.ModelAdmin):
    list_display = ["titulo", "coordinacion", "categoria_curso", "plataforma", "costo_total", "cuotas", "estado"]
    list_filter = ["coordinacion", "categoria_curso", "plataforma", "estado", "nivel", "modalidad"]
